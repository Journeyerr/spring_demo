CREATE TABLE `addresses` (
  ...
  `phone` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '手机号',
  `sex` enum('male','female','unknow') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unknow' COMMENT '性别',
  `longitude` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '经度',
  `latitude` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '纬度',
  `country` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '中国' COMMENT '所属国家',
  ...
  `complete_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '包含省市区详细地址',
  `description` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '详细地址',
